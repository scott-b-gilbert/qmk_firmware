...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_all(
        ...
        KC_LSFT, KC_Z,    KC_X,    KC_C,   KC_V,   KC_B,   KC_N,   KC_M,   KC_COMMA, KC_DOT,  KC_RSFT,          KC_UP,   KC_SLSH,
        KC_LCTL, KC_LGUI, KC_LALT,                         KC_SPC,                            KC_RALT, MO_FUNC, KC_LEFT, KC_DOWN, KC_RIGHT 
    ),
    [1] = LAYOUT_all(
        ...
        _______, _______, _______, _______, _______, RESET,   _______, _______, _______, _______, _______,          KC_VOLU, _______,
